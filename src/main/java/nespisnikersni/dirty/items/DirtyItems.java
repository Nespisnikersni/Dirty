...
public class DirtyItems{
    ...
    public static final Item DIAMOND_HAMMER = regItem("diamond_hammer",new PickaxeItem(ToolMaterials.DIAMOND, 7,-2.4f,new Item.Settings()));
    public static final Item IRON_HAMMER = regItem("iron_hammer",new PickaxeItem(ToolMaterials.IRON, 6,-2.4f,new Item.Settings()));
    public static final Item GOLDEN_HAMMER = regItem("golden_hammer",new PickaxeItem(ToolMaterials.GOLD, 5,-2.4f,new Item.Settings()));
    public static final Item STONE_HAMMER = regItem("stone_hammer",new PickaxeItem(ToolMaterials.STONE, 5,-2.4f,new Item.Settings()));
    public static final Item WOODEN_HAMMER = regItem("wooden_hammer",new PickaxeItem(ToolMaterials.WOOD, 4,-2.4f,new Item.Settings()));
    public static final Item NETHERITE_HAMMER = regItem("netherite_hammer",new PickaxeItem(ToolMaterials.NETHERITE, 8,-2.4f,new Item.Settings()));
    ...
    public static final Item WHITE_DUST = regItem("white_roots_dust",new Item(new Item.Settings()));
